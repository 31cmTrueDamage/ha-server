...
mysql -u root -p -e "GRANT SELECT ON mysql.time_zone_name TO cacti'@'192.168.30.121'; FLUSH PRIVILEGES;"
mysql -u root -p -e "GRANT SELECT ON mysql.time_zone_name TO cacti'@'192.168.30.122'; FLUSH PRIVILEGES;"
